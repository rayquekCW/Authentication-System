...
const Sidebar = ({handleClick}: SideBarProps) => {
    ...
    const [adminType, setAdminType] = useState("superAdmin"); //TODO: for demo of different admin types use protected routes and checking of tokens to determine admin type for actual implementation
