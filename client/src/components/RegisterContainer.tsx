      ...
      >
        ...
        <div className="text-center">
          ...
          <div className="">
            <div className="form-check">
              ...
              />
              <label className="form-check-label caption" htmlFor="consent">
                I consent to the use of my personal data for authentication
                purposes.
              </label>
            </div>
          </div>
        ...
        <button
          className={`defaultBtn ${
            validateEmailFormat(email) && validateDateFormat(dob) && isConsent
              ? ""
              : "disabled"
          }`}
          onClick={() => verify()}
