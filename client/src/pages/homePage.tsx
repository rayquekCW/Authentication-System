		...
		<>
			<div className="container bg-light shadow-sm mt-4">
				<div className="row p-3">
					<div className="col-md-4 col-12 text-start" >
						...
						<h4>Maurice Ho</h4>
						<br></br>
						<h6>Would you like to personalise your name? <a href="">Yes</a> or <a href="">No</a></h6>
						<br></br>
						<h6>Your last login was 10:58 PM on Tuesday 5th September 2023 (Singapore)</h6>
						<br></br>
						<h6><b>There are </b><a href="" className="text-secondary">no new message for you</a><b> for you</b></h6>
					</div>
			...
			<div className="container bg-light shadow-sm mt-4 pb-5">
				...
				<table className="table table-bordered h-50 text-center">
					<tr>
						<th className="text-start">POSB Passbook Savings Accounts </th>
						<td className="text-start">234-23455-6</td>
						<td > S$1,020,010,000.01
				...
				<h5 className="text-end pt-4 pe-4"> Total Available Balance S$55,040,020,000.02</h5>
			</div>
		</>
	);
};
