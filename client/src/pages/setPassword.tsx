					...
					<div className="container">
						<div className="boxInput row d-flex justify-content-center align-items-center">
							<div className=" p-2 rounded">
								<img className="mb-5 w-50 text-center" src="https://internet-banking.dbs.com.sg/IB/posb/images/desktoplogo.png" alt="" />
								...
								<div className="text-start">
									<input type="checkbox" className="mb-3" value="show" id="Show" />
									<label htmlFor="Show">Show Password</label>
								</div>
								<button className="rounded btn btn-sm defaultBtn mt-2">Set Password</button>
							</div>
						</div>
					</div>
				</div>
