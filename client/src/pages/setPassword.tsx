...
const SetPassword = () => {
	...
	const isChangePassword = useState(false);
							...
							<div className="text-center p-2 rounded">
								...
								<div>
									...
									<button 
										...
										onClick={() => setVerifyStatus(!isVerified)}
									>
										Verify
									</button>
								</div>
								):(null)}
								{( (!isChangePassword ||(isChangePassword && isVerified)) && !isSuccessful) ? (
								<div>
								...
								{(isSuccessful)?(
									<div>
										...
										<button className='defaultBtn mt-3'>Continue</button>
									</div>
								):(null)}
